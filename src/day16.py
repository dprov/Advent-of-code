...
@utils.timing.timing
def solve_part_1(valves: List[Valve], travel_times: ValveTupleDict):
...
@utils.timing.timing
def solve_part_2(valves: List[Valve], travel_times: ValveTupleDict):
    starting_valve_name = "AA"
...
if __name__ == "__main__":
    # Parse inputs
    valves = utils.io.parse_file_as_type("input/day16", ValveParser)
    travel_times = find_travel_times(valves)

    print("Part I")
    print(solve_part_1(valves, travel_times))

    print("Part II")
    print(solve_part_2(valves, travel_times))
