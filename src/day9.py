...
if __name__ == "__main__":
    moves = parse_input("input/day9")

    print("Part I")
    print(count_visited_by_tail(rope=RopeTracker(n_knots=2), moves=moves))

    print("Part II")
    print(count_visited_by_tail(rope=RopeTracker(n_knots=10), moves=moves))
