...
if __name__ == "__main__":
    operations = utils.io.parse_file_as_type("input/day10", OperationParser)

    processor = Processor()
    processor.apply_operations(operations)

    print("Part I")
    print(get_signal_strengths(processor=processor, cycle_inds=range(20, processor.cycle(), 40)))

    print("Part II")
    processor.print_display()
