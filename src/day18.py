...
# Solvers
@utils.timing.timing
def solve_part_1(droplet: LavaDroplet):
...
@utils.timing.timing
def solve_part_2(droplet: LavaDroplet):
...
if __name__ == "__main__":
    droplet = parse_input("input/day18")

    print("Part I")
    print(solve_part_1(droplet))

    print("Part II")
    print(solve_part_2(droplet))
